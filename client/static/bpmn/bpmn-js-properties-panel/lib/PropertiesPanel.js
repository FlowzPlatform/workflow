 ...
 */
function PropertiesPanel(config, eventBus, modeling, propertiesProvider, commandStack, canvas, data) {
...
PropertiesPanel.prototype._init = function (config) {
  ...
  eventBus.on('root.added', function (e) {
    self.update(e.element, config.data);
  });
 ...
 */
PropertiesPanel.prototype.update = function (element, data) {
  var current = this._current;
  ...
  var newTabs = this._propertiesProvider.getTabs(element, data);
...
var flattenDeep = require('lodash/array').flattenDeep,
  ...
  indexBy = require('lodash/keyBy'), // indexBy is replace to keyBy in new lodash version
