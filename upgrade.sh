...
-H 'Content-Type: application/json' \
-d '{
     "inServiceStrategy":{"launchConfig": {"imageUuid":"docker:obdev/flowz_backend_flowz:dev","kind": "container","labels":{"io.rancher.container.pull_image": "always","io.rancher.scheduler.affinity:host_label": "machine=cluster-flowz"},"ports": ["3033:3033/tcp"],"version": "5c95f163-665f-4512-8bba-5bfbfb56a94b","environment": {"RDB_HOST": "159.203.134.27","RDB_PORT": "28015"}}},"toServiceStrategy":null}' \
